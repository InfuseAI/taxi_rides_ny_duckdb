...
- Install, or update, DuckDB to 0.7.0
...
and the Metrics can also be compared and visualized in the PipeRider report.
...
- Join the PipeRider [Discourse](https://discourse.getdbt.com/) for help and discussion
